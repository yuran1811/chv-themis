...
export const PROBLEMS_DIR = process.env.PROBLEMS_DIR || resolve(__dirname, '../public/_problems');

export const SUBMISSIONS_DIR = process.env.SUBMISSIONS_DIR || resolve(__dirname, '../resources/uploads');

export const RANKING_DIR = process.env.RANKING_DIR || resolve(__dirname, '../resources/_rankings');

export const CONTESTANTS_DIR = process.env.CONTESTANTS_DIR || resolve(__dirname, '../resources/contestants');

export const TASKS_DIR = process.env.TASKS_DIR || resolve(__dirname, '../resources/tasks');
